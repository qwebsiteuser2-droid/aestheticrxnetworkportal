  ...
  generatePayFastIntegrationPDF(order: Order, paymentMethod: string = 'payfast_online', itnData?: any): Promise<Buffer> {
    return new Promise((resolve, reject) => {
      try {
        ...
        doc.fontSize(8)
           .fillColor('#7f8c8d')
           .text('This document was automatically generated by BioAestheticAx Network system', 50, 750, { align: 'center' })
  ...
  generateOrderSummaryPDF(order: Order, paymentMethod: string = 'payfast_online'): Promise<Buffer> {
    return new Promise((resolve, reject) => {
      try {
        ...
        doc.fontSize(8)
           .fillColor('#7f8c8d')
           .text('Generated by BioAestheticAx Network system', 50, 700, { align: 'center' });
